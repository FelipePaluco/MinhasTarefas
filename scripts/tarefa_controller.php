    ...
    if($acao == 'inserir') { // Verifica se o valor passado pelo método GET é de inserir.
        ...
        if($tarefaService->atualizar()) {
            if(isset($_GET['pag']) && $_GET['pag'] == 'index') {
                Header('Location: http://localhost/app_tarefa/www/index.php?editado=true');
            } else {
                Header('Location: http://localhost/app_tarefa/www/tarefas_pendentes.php?editado=true');
            }
        }  else {
            if(isset($_GET['pag']) && $_GET['pag'] == 'index') {
                Header('Location: http://localhost/app_tarefa/www/index.php?editado=false');
            } else {
                Header('Location: http://localhost/app_tarefa/www/tarefas_pendentes.php?editado=false');
        }
    }
        ...
        if(isset($_GET['pag']) && $_GET['pag'] == 'index') {
            Header('Location: http://localhost/app_tarefa/www/index.php?removido=true');
        } else {
