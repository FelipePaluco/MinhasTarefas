...
<html>
	<head>
		...
		function editar(id, txtTarefa) {
			...
			form.action = "../scripts/tarefa_controller.php?pag=tarefas_realizadas&acao=atualizar";
			form.method = "POST";
			form.className = 'row'
		...
		function marcarPendente(id) {
			location.href =  '../scripts/tarefa_controller.php?pag=tarefas_realizadas&acao=marcarPendente&id='+id;
		}
		</script>
	</head>
					...
					<div class="row">
						<div class="col">
							...
							<div class="row mb-3 d-flex align-items-center tarefa">
								...
								<?php } ?>
								<?php if($tarefas == null) {?>
									<p class="text-muted">Você não tem nenhuma tarefa realizada no momento.</p>
								<?php }?>
							</div>
						</div>
					</div>
